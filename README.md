...
![Soda](https://img.shields.io/badge/Soda-data%20quality-3ABEFF?style=for-the-badge)
...
![dbt lineage graph: three raw sources flow through staging and intermediate models into the tbl_common_patient_readmission_risk mart](readmission_risk_project_graph.png)

*Lineage graph generated by `dbt docs generate` / `dbt docs serve`.*
